...
class Decoder(nn.Module):
    def __init__(self, image_size, in_chans, features, latent_size):
        ...
        while convolutional_size < image_size//2:
...
class Generator(nn.Module):
    def __init__(self, project_parameters):
        super().__init__()
        self.encoder1 = Encoder(image_size=project_parameters.image_size,
                                ...
                                add_final_conv=True)
        self.decoder = Decoder(image_size=project_parameters.image_size,
                               in_chans=project_parameters.in_chans,
                               features=project_parameters.generator_features,
                               latent_size=project_parameters.latent_size)
        self.encoder2 = Encoder(image_size=project_parameters.image_size,
                                in_chans=project_parameters.in_chans,
                                features=project_parameters.generator_features,
                                latent_size=project_parameters.latent_size,
                                add_final_conv=True)
...
class Discriminator(nn.Module):
    def __init__(self, project_parameters):
        super().__init__()
        model = Encoder(image_size=project_parameters.image_size,
                        in_chans=project_parameters.in_chans,
